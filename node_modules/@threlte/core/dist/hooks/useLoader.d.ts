...
export interface SyncLoader extends ThreeLoader {
    load: (url: string, success: (data: any) => void, onProgress?: (event: ProgressEvent) => void, onError?: (event: ErrorEvent) => void) => void;
}
...
type LoaderResultType<TLoader extends Loader> = TLoader extends AsyncLoader ? Awaited<ReturnType<TLoader['loadAsync']>> : TLoader extends SyncLoader ? Awaited<ReturnType<TLoader['load']>> : never;
