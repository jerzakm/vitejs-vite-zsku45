<script>import { currentWritable, useFrame, useThrelte, watch } from '@threlte/core';
...
const csm = currentWritable(undefined);
...
watch([csm, lightIntensityStore, lightColorStore, useLegacyLights], ([csm, intensity, color, useLegacyLights]) => {
