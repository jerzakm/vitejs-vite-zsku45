...
function add_css(target) {
  append_styles(target, "svelte-o3oskp", "canvas.svelte-o3oskp{display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQ2FudmFzLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUFzSUUsb0JBQU8sQ0FDTCxPQUFPLENBQUUsS0FDWCIsIm5hbWVzIjpbXSwic291cmNlcyI6WyJDYW52YXMuc3ZlbHRlIl19 */");
}
...
function create_fragment5(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(canvas_1, file, 122, 0, 3810);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
function instance5($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("colorManagementEnabled" in $$props2)
      $$invalidate(4, colorManagementEnabled = $$props2.colorManagementEnabled);
    if ("colorSpace" in $$props2)
      $$invalidate(5, colorSpace = $$props2.colorSpace);
    if ("debugFrameloop" in $$props2)
      $$invalidate(6, debugFrameloop = $$props2.debugFrameloop);
    if ("dpr" in $$props2)
      $$invalidate(7, dpr = $$props2.dpr);
    if ("frameloop" in $$props2)
      $$invalidate(8, frameloop = $$props2.frameloop);
    if ("rendererParameters" in $$props2)
      $$invalidate(9, rendererParameters = $$props2.rendererParameters);
    if ("shadows" in $$props2)
      $$invalidate(10, shadows = $$props2.shadows);
    if ("size" in $$props2)
      $$invalidate(11, size = $$props2.size);
    if ("toneMapping" in $$props2)
      $$invalidate(12, toneMapping = $$props2.toneMapping);
...
//# sourceMappingURL=chunk-MQC4IAZG.js.map
